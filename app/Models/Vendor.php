...
class Vendor extends Model
{
    protected $fillable = [
        ...
        'payout_method', 'bank_swift', 'bank_branch', 'bank_branch_code', 'bank_account_type',
        'wallet_network_type', 'wallet_telecom', 'wallet_bank_name', 'wallet_phone',
        'paypal_email', 'paypal_name',
